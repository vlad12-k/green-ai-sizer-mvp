...
|---|---|---|
| Workbook CSV | Scenario inputs driving the CI carbon budget decision | `data/scenario-baseline-improved.csv` |
...
| T-08 | Probe run summary | **Repudiation** | Probe output committed without a clear provenance trail | Low | Low — evidence value is reduced | Probe script and methodology documented in `docs/evidence/data-sources.md`; commit message includes "probe" keyword | Low |
...
Owner: Security lead. Evidence: `SECURITY.md`, `docs/governance/controls.md` (C-05, C-08).
