...
| C-06 | System boundary and assumptions are documented | System Boundary boundary document maintained under version control | `docs/governance/system-boundary.md` | On assumption change; quarterly review |
